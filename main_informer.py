...
parser.add_argument('--enc_in', type=int, default=7, help='encoder input size(cols)')
parser.add_argument('--dec_in', type=int, default=7, help='decoder input size(cols)')
parser.add_argument('--c_out', type=int, default=7, help='output size')
parser.add_argument('--d_model', type=int, default=512,
                    help='dimension of model(the feature number of the outputs of '
...
for ii in range(args.itr):
    ...
    setting = ('{}_{}_ft{}_sl{}_ll{}_pl{}_dm{}_nh{}_'
               'el{}_dl{}_df{}_at{}_fc{}_eb{}_dt{}_'
               'mx{}_{}_{}').format(args.model,
                                    args.data,
                                    args.features,
                                    args.seq_len,
                                    args.label_len,
